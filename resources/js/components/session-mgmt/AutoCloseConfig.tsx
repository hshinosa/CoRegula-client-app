        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-brand-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            {currentTimeout && (
              <button
                ...
                className="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-brand-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50"
              >
                Disable
              </button>
            )}
