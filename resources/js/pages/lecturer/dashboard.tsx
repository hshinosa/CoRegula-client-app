...
const METRIC_LABELS = ['Hot', 'Lexical Variety', 'Forethought', 'Performance', 'Collaboration', 'Reflection'];
...
const MOCK_CLASSES: ClassEntity[] = [
    {
                ...
                students: [
                    {
                        id: 'cs401-g1-s1',
                        label: 'Andi Pratama',
                        sublabel: 'andi.pratama@kolabri.edu',
                        metrics: [8.8, 7.5, 9.0, 7.9, 9.4, 7.8],
                        note: 'Konsisten memimpin diskusi reflektif.',
                    },
                    {
                        id: 'cs401-g1-s2',
                        label: 'Bella Kusuma',
                        sublabel: 'bella.kusuma@kolabri.edu',
                        metrics: [7.9, 6.8, 8.4, 7.2, 8.6, 6.9],
                        note: 'Performa tinggi, refleksi mulai konsisten.',
                    },
                    {
                        id: 'cs401-g1-s3',
                        label: 'Cahya Adi',
                        sublabel: 'cahya.adi@kolabri.edu',
                        metrics: [8.5, 7.4, 8.6, 7.6, 9.0, 7.4],
                        note: 'Kontribusi seimbang di semua dimensi.',
                    },
                ],
            },
            {
                ...
                students: [
                    {
                        id: 'cs401-g2-s1',
                        label: 'Dimas Surya',
                        sublabel: 'dimas.surya@kolabri.edu',
                        metrics: [7.5, 6.2, 8.0, 6.6, 8.2, 5.8],
                        note: 'Stabil, perlu dorongan refleksi.',
                    },
                    {
                        id: 'cs401-g2-s2',
                        label: 'Eka Lestari',
                        sublabel: 'eka.lestari@kolabri.edu',
                        metrics: [6.9, 5.8, 7.4, 6.0, 7.8, 5.2],
                        note: 'Refleksi minimal, butuh prompt eksplisit.',
                    },
                ],
            },
            {
                ...
                students: [
                    {
                        id: 'cs401-g3-s1',
                        label: 'Farel Nugraha',
                        sublabel: 'farel.nugraha@kolabri.edu',
                        metrics: [7.8, 6.6, 8.2, 7.0, 8.4, 6.2],
                        note: 'Konsisten di semua dimensi.',
                    },
                    {
                        id: 'cs401-g3-s2',
                        label: 'Gita Anjali',
                        sublabel: 'gita.anjali@kolabri.edu',
                        metrics: [7.4, 6.2, 7.8, 6.6, 8.0, 5.8],
                        note: 'Lexical variety perlu didorong.',
                    },
                ],
            },
        ],
        sessionEntries: [
            {
                id: 'cs401-sess1',
                label: 'Sesi 1 — User Research Basics',
                sublabel: '4 Maret 2026 · 47 pesan',
                metrics: [6.8, 5.8, 7.5, 6.4, 7.8, 5.5],
                note: 'Pembukaan sesi cenderung pasif.',
            },
            {
                id: 'cs401-sess2',
                label: 'Sesi 2 — Persona & Empathy Map',
                sublabel: '11 Maret 2026 · 82 pesan',
                metrics: [7.6, 6.4, 8.0, 6.8, 8.4, 6.2],
                note: 'Diskusi mulai mendalam, ada momen refleksi.',
            },
            {
                id: 'cs401-sess3',
                label: 'Sesi 3 — Wireframing Sprint',
                sublabel: '18 Maret 2026 · 119 pesan',
                metrics: [8.4, 7.0, 8.6, 7.6, 9.0, 7.0],
                note: 'Sesi paling produktif sejauh ini.',
            },
            {
                id: 'cs401-sess4',
                label: 'Sesi 4 — Heuristic Evaluation',
                sublabel: '25 Maret 2026 · 96 pesan',
                metrics: [7.8, 6.6, 8.2, 7.2, 8.4, 6.4],
                note: 'Performa stabil, kolaborasi tetap kuat.',
            },
        ],
    },
    {
                ...
                students: [
                    {
                        id: 'cs402-g1-s1',
                        label: 'Hadi Wijaya',
                        sublabel: 'hadi.wijaya@kolabri.edu',
                        metrics: [6.8, 7.8, 7.2, 8.4, 7.6, 5.8],
                        note: 'Tech lead grup, diskusi cenderung dominan.',
                    },
                    {
                        id: 'cs402-g1-s2',
                        label: 'Indra Maulana',
                        sublabel: 'indra.maulana@kolabri.edu',
                        metrics: [6.0, 7.2, 6.8, 7.6, 6.8, 5.4],
                        note: 'Stabil, butuh dorongan refleksi.',
                    },
                ],
            },
            {
                ...
                students: [
                    {
                        id: 'cs402-g2-s1',
                        label: 'Joko Saputra',
                        sublabel: 'joko.saputra@kolabri.edu',
                        metrics: [5.6, 6.6, 6.4, 7.4, 6.4, 5.0],
                        note: 'Pasif, jarang mengelaborasi.',
                    },
                ],
            },
        ],
        sessionEntries: [
            {
                id: 'cs402-sess1',
                label: 'Sesi 1 — Agile Foundations',
                sublabel: '5 Maret 2026 · 38 pesan',
                metrics: [5.4, 6.8, 6.2, 7.4, 6.4, 5.0],
                note: 'Sesi orientasi, partisipasi cukup.',
            },
            {
                id: 'cs402-sess2',
                label: 'Sesi 2 — User Stories',
                sublabel: '12 Maret 2026 · 64 pesan',
                metrics: [6.0, 7.2, 6.6, 7.8, 6.8, 5.2],
                note: 'Diskusi mulai konstruktif.',
            },
            {
                id: 'cs402-sess3',
                label: 'Sesi 3 — Sprint Planning',
                sublabel: '19 Maret 2026 · 78 pesan',
                metrics: [6.4, 7.6, 7.2, 8.2, 7.0, 5.6],
                note: 'Tertinggi, performa tim solid.',
            },
        ],
    },
    {
                ...
                students: [
                    {
                        id: 'cs403-g1-s1',
                        label: 'Kirana Putri',
                        sublabel: 'kirana.putri@kolabri.edu',
                        metrics: [9.0, 8.4, 8.0, 8.8, 8.2, 8.0],
                        note: 'Top performer kelas ini.',
                    },
                ],
            },
            {
                ...
                students: [
                    {
                        id: 'cs403-g2-s1',
                        label: 'Lukman Hakim',
                        sublabel: 'lukman.hakim@kolabri.edu',
                        metrics: [8.4, 8.0, 7.4, 8.2, 7.8, 7.6],
                        note: 'Konsisten teknikal & reflektif.',
                    },
                ],
            },
        ],
        sessionEntries: [
            {
                id: 'cs403-sess1',
                label: 'Sesi 1 — HTML/CSS Refresher',
                sublabel: '6 Maret 2026 · 52 pesan',
                metrics: [7.8, 7.4, 7.0, 7.8, 7.2, 7.0],
                note: 'Pembukaan ringan, partisipasi luas.',
            },
            {
                id: 'cs403-sess2',
                label: 'Sesi 2 — Component Patterns',
                sublabel: '13 Maret 2026 · 88 pesan',
                metrics: [8.6, 8.2, 7.6, 8.4, 7.8, 7.6],
                note: 'Diskusi mendalam, banyak code review.',
            },
        ],
    },
];
...
const RadarChartPage: React.FC = () => {
    ...
    const activeClass = useMemo(() => MOCK_CLASSES.find((c) => c.id === activeClassId) ?? MOCK_CLASSES[0], [activeClassId]);
    ...
    const summaryCards = useMemo(
        () => [
            ...
            { icon: BookOpen, label: 'Sesi Diskusi', value: activeClass.sessions },
            {
                ...
                value: (primaryEntity.metrics.reduce((a, b) => a + b, 0) / primaryEntity.metrics.length).toFixed(1),
            },
        ],
        ...
        <AppLayout title="Radar Metrik" navItems={navItems}>
            ...
            <div className="relative">
                ...
                <div className="relative space-y-6">
                    {/* Kartu Selamat Datang dari dashboard.tsx */}
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <div>
                                    ...
                                    <p className={`mt-2 max-w-2xl ${bodyTextClass}`}>
                                        Lihat enam metrik SSRL pada empat tingkat agregasi. Aktifkan mode bandingkan untuk overlay dua entitas, dan
                                        periksa tabel rincian skor di bawah radar.
                                    </p>
                                </div>
                                <div className="flex flex-wrap items-center gap-2">
                                    <label className="text-xs tracking-wider text-[#6B7280] uppercase">Kelas:</label>
                                    <select
                                        value={activeClassId}
                        ...
                        {summaryCards.map(({ icon: Icon, label, value }) => (
                            <LiquidGlassCard key={label} intensity="medium" className="p-4" lightMode={true}>
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <p className="text-xs tracking-wider text-[#6B7280] uppercase">{label}</p>
                    ...
                    >
                        <LiquidGlassCard intensity="medium" className="p-6 lg:col-span-1" lightMode={true}>
                            ...
                            <div className="mt-3">
                                <label className="text-xs tracking-wider text-[#6B7280] uppercase">Urutkan:</label>
                                <select
                                    value={sortMode}
                                        ...
                                        >
                                            <div className="flex items-center justify-between gap-2">
                                                <p
                                                    ...
                                                    style={{ color: isPrimary ? '#88161c' : isSecondary ? '#475569' : '#4A4A4A' }}
                                                >
                                                    {item.title}
                                                </p>
                                                <div className="flex items-center gap-1.5">
                                                    <span className="rounded-full px-2 py-0.5 text-[10px] font-semibold" style={tone}>
                                                    ...
                                                    {comparisonMode && (
                                                        <span
                                                            ...
                                                            style={
                                                                isPrimary
                                                                    ? { background: 'rgba(136,22,28,0.18)', color: '#88161c' }
                                                                    : isSecondary
                                                                      ? { background: 'rgba(71,85,105,0.18)', color: '#475569' }
                            ...
                            <div className="mt-4 grid grid-cols-1 gap-3">
                                <div className="rounded-2xl p-4" style={{ background: 'rgba(255,255,255,0.45)' }}>
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <p className="text-xs font-semibold tracking-wider text-[#88161c] uppercase">{primaryEntity.label}</p>
                                ...
                                {secondaryEntity && (
                                    <div className="rounded-2xl p-4" style={{ background: 'rgba(71,85,105,0.06)' }}>
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                <p className="text-xs font-semibold tracking-wider uppercase" style={{ color: '#475569' }}>
                                                    {secondaryEntity.label}
                                                </p>
