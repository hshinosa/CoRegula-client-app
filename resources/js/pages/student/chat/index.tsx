                    ...
                    <div className="min-h-0 flex-1 overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
                        ...
                        <div className="border-t border-zinc-200 p-2 dark:border-zinc-700 sm:p-4">
                            ...
                            <form onSubmit={handleSubmit} className="flex gap-1.5 sm:gap-2">
                                ...
                                <div className="relative flex-1">
                                    <input
                                        ...
                                        className="input-field h-10 w-full text-sm sm:h-11 sm:text-base"
                                    />
                                </div>
                                ...
                                <button
                                    ...
                                    className="btn-primary flex h-10 items-center gap-1 px-3 transition-transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 sm:h-11 sm:gap-2 sm:px-4"
                                >
                                    {isUploading ? (
                            ...
                            <p className="mt-1.5 text-center text-xs text-zinc-400 sm:mt-2">
                                Tips: Sebut <span className="font-medium text-primary-500">@agent</span> untuk memberikan tugas atau merangkum diskusi.
                            </p>
                        </div>
                    </div>
                </div>
