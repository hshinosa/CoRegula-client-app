    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold" style={{ color: '#4A4A4A', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                    Template Refleksi
                </h3>
                <button
                    type="button"
            ...
            <div className="relative">
                ...
                <input
                    ...
                    className="w-full rounded-lg border-0 bg-white/60 py-2 pl-10 pr-8 text-sm text-[#4A4A4A] ring-1 ring-inset ring-white/50 placeholder:text-[#9ca3af] focus:ring-2 focus:ring-inset focus:ring-[#88161c]/30"
                ...
                {searchQuery && (
                    <button
                        ...
                        className="absolute right-3 top-1/2 -translate-y-1/2 text-[#6B7280] hover:text-[#4A4A4A]"
                    >
                        <X className="h-4 w-4" />
                    </button>
                )}
            ...
            {loading ? (
                ...
                <div className="flex flex-col items-center justify-center py-8 text-center">
                    <FileText className="mb-2 h-8 w-8 text-[#6B7280]" />
                    <p className="text-sm text-[#6B7280]">Belum ada template</p>
                </div>
            ) : (
